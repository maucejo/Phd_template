...
#example-box[
  ...
  subfigure(image("image1.png", width: 100%), caption: [Titre]),
  [#subfigure(image("image2.png", width: 100%), caption: []) <b>]
  ),
